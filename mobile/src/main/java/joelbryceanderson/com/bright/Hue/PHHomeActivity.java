...
public class PHHomeActivity extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView splashFooter = (TextView) findViewById(R.id.splash_app_name);
        relativeLayout = (RelativeLayout) findViewById(R.id.linear1);
        card.setVisibility(View.GONE);
        // Gets an instance of the Hue SDK.
        phHueSDK = PHHueSDK.create();
        
        // Set the Device Name (name of your app). This will be stored in your bridge whitelist entry.
        phHueSDK.setAppName("BrightApp");
        ...
        public void onError(int code, final String message) {
            ...
            if (code == PHHueError.NO_CONNECTION) {
                ...
                PHHomeActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Snackbar.make(relativeLayout, "Could not find bridge",
                                ...
                                if (lastIpAddress !=null && !lastIpAddress.equals("")) {
                                    ...
                                    if (!phHueSDK.isAccessPointConnected(lastAccessPoint)) {
                                        Snackbar.make(relativeLayout,
                                                R.string.connecting, Snackbar.LENGTH_SHORT).show();
                                        phHueSDK.connect(lastAccessPoint);
                                    }
                                }
                            }

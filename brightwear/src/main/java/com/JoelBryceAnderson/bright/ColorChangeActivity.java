    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stub.setOnLayoutInflatedListener(new WatchViewStub.OnLayoutInflatedListener() {
            ...
            public void onLayoutInflated(WatchViewStub stub) {
                final ImageView spectrum = (ImageView) stub.findViewById(R.id.large_spectrum);
                final ImageView color = (ImageView) stub.findViewById(R.id.color_select);
                position = getIntent().getIntExtra("position", 1);
                currentColor = 0;
                final Bitmap bitmap = ((BitmapDrawable) spectrum.getDrawable()).getBitmap();
                spectrum.setOnTouchListener(new View.OnTouchListener() {
                    @Override
                ...
                spectrum.setOnLongClickListener(new View.OnLongClickListener() {
                    @Override
